...
/*
Use variables a and b to make the explanation a bit nicer.
...
hundreds-digit of n is 1 for prefixes "0" to "3141", i.e., 3142 times. Each of those times is a streak, 
...
prefixes "0" to "314", so 315 times. And each time is a streak of 1000 numbers. However, since the 
...
expression. With (a + 8) / 10 you get the number of full streaks, and a % 10 == 1 tells you whether to 
add a partial streak.
Reference:
