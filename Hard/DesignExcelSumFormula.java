...
class Excel {
    ...
    private class Cell {
        ...
        public void setValue(int val) {
            this.formula.clear(); //will not be treated as a formula cell anymore        
            this.val = val;
        }
        ...
        private void addFormulaCell(int r, int c) {
            ...
            this.formula.put(rangeCell, this.formula.getOrDefault(rangeCell, 0) + 1);
        }
        ...
        private int getValue() {
            ...
            int sum = 0;
            for (Cell cell : this.formula.keySet()) {
                sum += cell.getValue() * this.formula.get(cell);
            }
            return sum;
        }
    }
