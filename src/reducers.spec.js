...
describe('Validate reducer (no fetch requests here)', ()=> {
	...
	it('should set the articles',()=> {
		expect(articles(undefined,{type:Action.UPDATE_ARTICLES, articles:{
			1:{_id:1, text:'hello world!', author:'by8',date:'2016-10-24'}
		}}))
		.to.eql({keyword:'', articles:{1:{_id:1, text:'hello world!', author:'by8',date:'2016-10-24'}}})
	})
	...
	it('should filter displayed articles by the search keyword',()=> {
		const articles = {1:{_id:1, text:'hello world!', author:'by8', date:'2016-10-24'},
						  2:{_id:2, text:'hello javascript', author:'by8', date:'2016-10-24'}}
		const keyword = 'world'
		expect(filterFunction(articles,keyword)).to.eql([{_id:1, text:'hello world!', author:'by8', date:'2016-10-24'}]);
	})
})